...
fun DeliveryScreen(
    ...
    val deliveryValues = DeliveryValues
    val titleFontSize = deliveryValues.titleFontSize
    var allProductsList by remember { mutableStateOf<List<Row>>(emptyList()) }

    val logoutFontSize = deliveryValues.logoutFontSize
    val mainContentTopPadding = deliveryValues.mainContentTopPadding
    val normalTextFontSize = deliveryValues.normalTextFontSize
    val topRowTopPadding = deliveryValues.topRowTopPadding
    val mainContentColumnTopPadding = deliveryValues.mainContentColumnTopPadding
    val columnHeight = deliveryValues.columnHeight
    val gridBottomPadding = deliveryValues.gridBottomPadding
    val buttonColumnHeight = deliveryValues.buttonColumnHeight
    val buttonColumnPadding = deliveryValues.buttonColumnPadding
    val buttonColumnVerticalArrangement = deliveryValues.buttonColumnVerticalArrangement
            ...
            Column(
                        ...
                        viewModel.dashboardDataFromApi?.Rows?.let {
                            ...
                            if (isGridView.value) {
                                LazyVerticalGrid(
                                    columns = GridCells.Fixed(2), content = {
                                        items(items = allProductsList) {roww->
                                            TKOrderCardView(roww, navController, viewModel)
                                        }
                                    },
                                    modifier = Modifier
                                        .padding(
                                ...
                                LazyColumn(
                                    content = {
                                        items(items = allProductsList) {roww->
                                            TKOrderListView(roww, navController, viewModel)
                                        }
                                    },
                                    modifier = Modifier
                ...
                Column(
                    ...
                    Box(
                        Modifier
                            .clickable {
                                viewModel.onEvent(DeliveryEvents.OnNewOrderClick)
                            }
                            .height(65.dp)
                            .width(190.dp)
...
@Composable
fun TKOrderCardView(order: Row, navController: NavController, viewModel: DeliveryViewModel) {
    val context = LocalContext.current
    val titleFont = ResourcesCompat.getFont(context, com.corn.cornpos.R.font.poppins_semibold)
    val regularFont = ResourcesCompat.getFont(context, com.corn.cornpos.R.font.poppins)
    ...
    val deliveryValues = DeliveryValues
    val orderCardViewHorizontalPadding = deliveryValues.orderCardViewHorizontalPadding
    val orderCardViewVerticalPadding = deliveryValues.orderCardViewVerticalPadding
    val orderCardViewHeight = deliveryValues.orderCardViewHeight
    val orderCardViewIconSize = deliveryValues.orderCardViewIconSize
    val normalTextFontSize = deliveryValues.normalTextFontSize
    ...
    Card(
        ...
        Row(
            ...
            Text(
                text = "Order # ${order.OrderNO}", fontFamily = FontFamily(titleFont!!),
                fontSize = normalTextFontSize,
                color = Color.White
            )
                ...
                modifier = Modifier
                    ...
                    .clickable {
                        CoroutineScope(Dispatchers.IO).launch {
                            ...
                            if (order.OrderDetail != null) {
                                ...
                                orders.forEach { myOrder ->
                                    CoroutineScope(Dispatchers.IO).launch {
                                        viewModel.dataBaseRepository.insertOrder(
                                            OrderDetails(
                                                itemId = myOrder.ID,
                        ...
                        navController.navigate(
                            "oderDetailScreen/order={order}".replace(
                                "{order}",
                                userJson
                            )
                        )
...
@Composable
fun TKOrderListView(order: Row, navController: NavController, viewModel: DeliveryViewModel) {
    val context = LocalContext.current
    val titleFont = ResourcesCompat.getFont(context, com.corn.cornpos.R.font.poppins_semibold)
    val regularFont = ResourcesCompat.getFont(context, com.corn.cornpos.R.font.poppins)
    val deliveryValues = DeliveryValues
    val orderListViewHorizontalPadding = deliveryValues.orderListViewHorizontalPadding
    val orderListViewHeight = deliveryValues.orderListViewHeight
    val orderListViewWidth = deliveryValues.orderListViewWidth
    val orderListViewNormalTextFontSize = deliveryValues.orderListViewNormalTextFontSize
    val orderListViewIconSize = deliveryValues.orderListViewIconSize
