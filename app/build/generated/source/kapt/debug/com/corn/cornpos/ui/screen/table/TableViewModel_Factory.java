...
public final class TableViewModel_Factory implements Factory<TableViewModel> {
  ...
  public TableViewModel_Factory(Provider<CornPosRepository> repositoryProvider,
  ...
  public static TableViewModel_Factory create(Provider<CornPosRepository> repositoryProvider,
      Provider<CornDataBaseRepository> dataBaseRepositoryProvider,
      Provider<Context> applicationProvider) {
    return new TableViewModel_Factory(repositoryProvider, dataBaseRepositoryProvider, applicationProvider);
  }

  public static TableViewModel newInstance(CornPosRepository repository,
      CornDataBaseRepository dataBaseRepository, Context application) {
    return new TableViewModel(repository, dataBaseRepository, application);
  }
}
